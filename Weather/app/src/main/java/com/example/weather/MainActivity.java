...
import bean.FutureWeatherBean;
import bean.HoursWeatherBean;
import bean.PMBean;
...
public class MainActivity extends Activity {
    ...
    private void setHourData(TextView tv_hour, ImageView iv_weather, TextView tv_temp, HoursWeatherBean bean) {
        ...
        iv_weather.setImageResource(getResources().getIdentifier(prefixStr + bean.getWeather_id(), "mipmap", "com.example.weather"));
    ...
    private void setWeatherViews(WeatherBean bean) {
        ...
        iv_today_weather.setImageResource(getResources().getIdentifier("d" + bean.getWeather_id(), "mipmap", "com.example.weather"));
        ...
        iv_now_weather.setImageResource(getResources().getIdentifier(prefixStr + bean.getWeather_id(), "mipmap", "com.example.weather"));
        ...
        tv_felt_temp.setText(bean.getFelt_temp());
    ...
    private void setFutureData(TextView tv_week, ImageView iv_weather, TextView tv_temp_a, TextView tv_temp_b, FutureWeatherBean bean) {
        ...
        iv_weather.setImageResource(getResources().getIdentifier("d" + bean.getWeather_id(), "mipmap", "com.example.weather"));
        String[] tempArr = bean.getTemp().split("~");
        String temp_str_a = tempArr[1].substring(0, tempArr[1].indexOf("℃"));
        String temp_str_b = tempArr[0].substring(0, tempArr[0].indexOf("℃"));
    ...
    private void init() {
        ...
        rl_city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(context,CityActivity.class),1);
        ...
        tv_next_three_temp = (TextView) findViewById(R.id.tv_nexttemp_three);
        tv_next_six_temp = (TextView) findViewById(R.id.tv_nexttemp_six);
        tv_next_nine_temp = (TextView) findViewById(R.id.tv_nexttemp_nine);
        tv_next_twelve_temp = (TextView) findViewById(R.id.tv_nexttemp_twelve);
        tv_next_fifteen_temp = (TextView) findViewById(R.id.tv_nexttemp_fifteen);
        ...
        tv_fourthday_temp_a = (TextView) findViewById(R.id.tv_forthday_temp_a);
        tv_fourthday_temp_b = (TextView) findViewById(R.id.tv_forthday_temp_b);
        ...
        tv_felt_temp = (TextView) findViewById(R.id.tv_felt_air_temp);
        ...
        iv_tommorrow_weather = (ImageView) findViewById(R.id.iv_tomorrow_weather);
        iv_thirdday_weather = (ImageView) findViewById(R.id.iv_thirdday_weather);
        iv_fourthday_weather = (ImageView) findViewById(R.id.iv_forthday_weather);
    }
